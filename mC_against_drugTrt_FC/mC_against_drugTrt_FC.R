...
EXPRESSION_DATA_PATH = c("./inputs/expression/DMSO1.bam.cntTable.cleaned",
                         "./inputs/expression/DMSO2.bam.cntTable.cleaned",
                         "./inputs/expression/DMSO3.bam.cntTable.cleaned",
                         "./inputs/expression/Aza1.bam.cntTable.cleaned",
                         "./inputs/expression/Aza2.bam.cntTable.cleaned",
                         "./inputs/expression/Aza3.bam.cntTable.cleaned")
FASTA_INDEX_PATH = "./inputs/genomes/Apar_genome_pUC19_lambda.fasta.fai"
BLACKLISTED_REGION = "./inputs/amoebidium/Blacklisted.regions.0based.bed"
...
compare_methylation_from_emseq_vs_expression_change_in_drug_trt <- function(BS, use.ch=FALSE, figure_title){
  GENE_SE <- gene_annotation_summarizedexperiment(BS, GENE_GTF_PATH, SLENGTHS, UPSTREAM = 2000, DOWNSTREAM = 400)
  for (subject_name in c("gene", "promoter")) {
...
compare_methylation_from_emseq_vs_expression_change_in_drug_trt(BS_cgc_CG, figure_title = "CGC")
compare_methylation_from_emseq_vs_expression_change_in_drug_trt(BS_non_cgc_CG, figure_title = "(non)CGC")