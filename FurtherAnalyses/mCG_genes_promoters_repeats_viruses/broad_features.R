...
REPEAT_GTF_PATH <- "Aapp_genome.RepeatMasker.kimura.gtf.gz" #This is Aapp_genome.RepeatMasker.bed.gz, converted to gtf format and with an additional column for Kimura distances 
VIRAL_GTF_PATH <- "GiantRepeats.gtf" #This is GiantRepeats.bed.gz in gtf format
...
broad_features <- function(BS, title){
  ...
  #Separate into gene SE, and promoter SE
